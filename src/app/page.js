    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
        ...
        <div className="relative">
          <img src="/asset/banner.jpeg" alt="Student Learning" className="w-full h-auto object-contain z-10 relative drop-shadow-2xl" />
        </div>
      </div>

      {/* 2. Stats Banner */}
      <div className="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 p-8 mb-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 divide-x divide-gray-100">
          <div className="flex items-center justify-center gap-4">
            ...
            <div>
              <h3 className="text-2xl font-bold text-gray-900"><AnimatedNumber end={10} suffix="K+" /></h3>
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            <div>
              <h3 className="text-2xl font-bold text-gray-900"><AnimatedNumber end={200} suffix="+" /></h3>
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            <div>
              <h3 className="text-2xl font-bold text-gray-900"><AnimatedNumber end={50} suffix="+" /></h3>
